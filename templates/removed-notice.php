 ...
 *
 * This template can be overridden by copying it to yourtheme/posterno/favourites/removed-notice.php
 *
...
<div class="alert alert-success pno-favs-notice" style="display:none;position: fixed;top: 0;z-index: 99999;width: 100%;border-radius:0;padding:1.25rem;text-align:center;" role="alert">
	<?php esc_html_e( 'Listing successfully removed from your favourites.', 'posterno-favourites' ); ?>
</div>
